...
def change_res_id(file_name):
  ...
  for name in parse(file_name):
      ...
      if old_chain == name['chain']: 
        if old != name['resnum'] or old_name != name['resname']:
          old = name['resnum']
          old_name = name['resname']
          counter += 1
        name['resnum'] = counter
...
pdb_filename1 = "/disk1/fingerprint/tmp/4FQI_AB copy"
pdb_filename2 = "/disk1/fingerprint/provaESMFold/4FQI_A_ESMFold"
